...
engine = create_engine(
    "postgresql://postgres:postgres@db:5432/transit", echo=opts.verbose)
        ...
        try:
            ...
            if opts.tripUpdates:
                ...
                if fm.header.gtfs_realtime_version != u'1.0':
                    logging.warning(
                        'Warning: feed version has changed: found %s, expected 1.0', fm.header.gtfs_realtime_version)
                ...
                if fm.header.gtfs_realtime_version != u'1.0':
                    ...
                    for entity in fm.entity:
                        ...
                        dbalert = Alert(
                            ...
                            cause=alert.DESCRIPTOR.enum_types_by_name[
                                'Cause'].values_by_number[alert.cause].name,
                            effect=alert.DESCRIPTOR.enum_types_by_name[
                                'Effect'].values_by_number[alert.effect].name,
